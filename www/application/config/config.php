...
|
*/
$server_host_name = isset($_SERVER['HTTP_HOST']) ? $_SERVER['HTTP_HOST'] : '';
$root = (isset($_SERVER['HTTPS']) ? "https://" : "http://") . $_SERVER['HTTP_HOST'];
// $root = "http://" . $server_host_name;
...
|
*/
$config['encryption_key'] = 'appsappsapps2020';
...
$config['sess_cookie_name'] = str_replace('.','',$server_host_name) . '_ci_session';
...
$config['csrf_token_name'] = str_replace('.','',$server_host_name) . '_csrf_token';
$config['csrf_cookie_name'] = str_replace('.','',$server_host_name) . '_csrf_cookie';
