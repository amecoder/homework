...
CREATE TABLE IF NOT EXISTS `homework`.`member` (
  ...
  INDEX `email_INDEDX` (`email` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `homework`.`order` (
  ...
  UNIQUE INDEX `order_no_UNIQUE` (`order_no` ASC) INVISIBLE,
  INDEX `order_no_index` (`order_no` ASC) VISIBLE)
ENGINE = InnoDB;
